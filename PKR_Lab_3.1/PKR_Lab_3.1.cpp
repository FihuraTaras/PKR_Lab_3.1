...
int main() {
    ...
    cout << "Kiлькiсть оцiнок «вiдмiнно» з педагогiки " << pedFive(s, amSt) << endl;

    cout << "Відсоток студентiв, якi отримали з фiзики i математики оцiнки «5»: " << (fivePhAndMath(s, amSt) / amSt) * 100 << "%" << endl;
